           ...
           {activeTab === 'STAFF' && (
             <div className="space-y-6 animate-in slide-in-from-left-4">
                ...
                <div className="grid grid-cols-1 gap-4">
                  {staff.map(s => (
                    <div key={s.id || s.identifier} className="flex items-center justify-between p-6 bg-slate-50 rounded-3xl border border-slate-100 group">
                       <div className="flex items-center gap-4">
                          ...
                          <div>
                             ...
                             <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest mt-1">Role: {s.role}</p>
                          </div>
                       </div>
                    </div>
                  ))}
